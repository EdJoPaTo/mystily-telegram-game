...
export type BarracksArmyType = 'villager' | 'archer' | 'swordfighter'
export type ArmyType = BarracksArmyType | 'cleric' | 'mystic'
export type WeaponType = 'melee' | 'ranged' | 'mystical'

export const PLAYER_ARMY_TYPES: readonly ArmyType[] = ['villager', 'archer', 'swordfighter', 'cleric']
export const PLAYER_BARRACKS_ARMY_TYPES: readonly BarracksArmyType[] = ['villager', 'archer', 'swordfighter']
